...
public class ModItems
{
    ...
    public static final ItemRoddenberry ingotDolamide = new ItemIngotDolamide();
    ...
    public static final ItemRoddenberry dustDolamide = new ItemDustDolamide();
    ...
    public static void init()
    {
        ...
        GameRegistry.registerItem(ingotDolamide, "dolamideIngot");
        ...
        GameRegistry.registerItem(dustDolamide, "dolamideDust");
